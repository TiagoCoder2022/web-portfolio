  ...
  return (
    <section id="home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
        ...
        >
            ...
            <a
                className="group bg-white text-gray-700 px-7 py-3 flex items-center gap-2 rounded-full outline-none hover:text-gray-950 focus:scale-110 hover:scale-110 active:scale-105 transition borderBlack cursor-pointer"
                href="/CV.pdf"
                download
            >
                Download CV{" "}
            ...
            <a
                ...
                href="https://www.linkedin.com/in/tiago-dev"
                target="_blank"
            >
                <BsLinkedin />
            </a>
